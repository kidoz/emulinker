...
public class ServerStatus extends V086Message {
    ...
    public static class User {
        ...
        public User(String userName, long ping, byte status, int userID, byte connectionType)
            ...
            if (connectionType < 1 || connectionType > 6)
                throw new MessageFormatException("Invalid " + DESC
                        + " format: connectionType out of acceptable range: " + connectionType);
        ...
        public String toString() {
            return "[userName=" + userName + " ping=" + ping + " status="
                    + org.emulinker.kaillera.model.KailleraUser.STATUS_NAMES[status] + " userID="
    ...
    public static class Game {
        ...
        public Game(String romName, int gameID, String clientType, String userName, String players,
            ...
            if (status < 0 || status > 2)
                throw new MessageFormatException("Invalid " + DESC
                        + " format: gameStatus out of acceptable range: " + status);
        ...
        public String toString() {
            return "[romName=" + romName + " gameID=" + gameID + " clientType=" + clientType
                    + " userName=" + userName + " players=" + players + " status="
        ...
        public int getLength() {
            ...
            return (romName.length() + 1 + 4 + clientType.length() + 1 + userName.length() + 1
                    + players.length() + 1 + 1);
        }
